...
public class Operator {
	...
	public static void main(String[] args) {
		...
		// 나눗셈 연산자 : /
		// 좌항에 우항을 나눈 값을 반환(int로 나눠서 int로 받은 것. 무조건 몫만 반환하는게 아님)
		...
		// 실수와 정수를 연산하면 실수가 반환됨 ex) double remainderResult4 = 8.0 * 3 
		...
		int number2 =  8;
		int number3 = 3;
		int sampleNumber = number2 / number3++; //(number3은 ;이후 4가됨)
		...
		// -> and는 하나만 false여도 뒤에거 보지 않고 false반환
		// -> or는 하나만 true여도 뒤에거 보지 않고 true반환
