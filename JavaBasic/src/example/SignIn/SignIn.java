...
public class SignIn {
	...
	public static void main(String[] args) {
		...
		// 문자열에서 값이 비어었는지 확인하는 기능(메서드)가 존재
		// string.isEmpty (): 비었으면 true, 아니면 false
		// isEmpty에 is가 있기 때문에 true,false로 나옴
		// 같은 라인,위치면 or,
		// 안에 있거나 다른위치면 and를 쓴다.
		...
		// if (uwerId.equal(ID) && !userPassword.equals(PASSWORD)) {
