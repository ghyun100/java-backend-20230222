...
interface ExampleInterface {
	...
	// 메서드를 사용 할 때는 public abstract로 선언해야 함, 밑에 애들처럼 써도됨 -> 인터페이스라 자바가 알아서 인식하기때문
...
public class Interface {
	...
	public static void main(String[] args) {
		...
		ExampleInterface exampleInterface = new Implement(); // -> 구현한 애로만 쓸 수 있음
