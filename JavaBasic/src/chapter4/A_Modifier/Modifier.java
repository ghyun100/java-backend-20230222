...
// 제어자 
// 클래스, 변수 또는 메서드의 선언부에서 사용되는 부가적 의미를 추가해주는 키워드
...
//static 제어자 (쓰는이유: 인스턴스없이 쓸 수 있다는 걸보여주려고)
// 해당 제어자가 포함되어있는 선언문은 클래스 단위로 사용가능하도록 함
// 멤버 변수, 멤버 메서드에서 사용가능
class Example1 {
	static int number1;
...
//final 제어자
// 해당 제어자가 포함되어 있는 선언문은 변경이 불가능 하도록 함
// 클래스, 메서드, 변수에서 사용가능
